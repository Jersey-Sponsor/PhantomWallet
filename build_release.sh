...
# zip
zip -r bin/release/PhantomWallet-1-0-0-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-1-0-0-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-1-0-0-osx.zip bin/PhantomWallet-osx
