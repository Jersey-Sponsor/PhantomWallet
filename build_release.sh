...
# zip
zip -r bin/release/PhantomWallet-0-8-8-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-8-8-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-8-8-osx.zip bin/PhantomWallet-osx
