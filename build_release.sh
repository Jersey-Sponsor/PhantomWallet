...
# zip
zip -r bin/release/PhantomWallet-0-9-5-linux.zip bin/PhantomWallet-linux
zip -r bin/release/PhantomWallet-0-9-5-windows.zip bin/PhantomWallet-win
zip -r bin/release/PhantomWallet-0-9-5-osx.zip bin/PhantomWallet-osx
