    ...
    public class AccountController
    {
            ...
            string destinationChainAddress)
        {
            try
            {
                ...
                var settleTx = new Phantasma.Blockchain.Transaction(nexusName, destinationChainName, settleTxScript, DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
            ...
            string chainName, string destinationChain, string symbol, string amountId)
        {
            try
            {
                ...
                var tx = new Phantasma.Blockchain.Transaction(nexusName, chainName, script, DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
                tx.Sign(keyPair);
            ...
            try
            {
              ...
              var script = ScriptUtils.BeginScript()
                ...
                var tx = new Phantasma.Blockchain.Transaction(nexusName, chainName, bscript,
                    DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
                tx.Sign(keyPair);
        ...
        public async Task<object> CreateMultisigWallet(PhantasmaKeys keyPair, MultisigSettings settings)
        {
            try
            {
                ...
                var nexusName = WalletConfig.Network;
                var tx = new Phantasma.Blockchain.Transaction(nexusName, "main", script, DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
                ...
                PhantasmaKeys keyPair, string chain, string contract, string method, object[] paramArray)
        {
            try
            {
                ...
                var nexusName = WalletConfig.Network;
                var tx = new Phantasma.Blockchain.Transaction(nexusName, chain, script, DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
                ...
                PhantasmaKeys keyPair, string chain, string contract, string method, object[] paramArray, string idArr, string quoteSymbol, string priceArr, string creatorArr)
        {
            try
            {
              ...
              var script = ScriptUtils.BeginScript()
                ...
                var nexusName = WalletConfig.Network;
                var tx = new Phantasma.Blockchain.Transaction(nexusName, chain, bscript, DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
                ...
                PhantasmaKeys keyPair, string stakeAmount)
        {
          try
          {
            ...
            var nexusName = WalletConfig.Network;
            var stakeTx = new Phantasma.Blockchain.Transaction(nexusName, "main", script, DateTime.UtcNow + TimeSpan.FromMinutes(30), "PHT-0-9-6");
